...
def get_recc(att_df, cat_rating):
    ...
    num_vis = ratings.attraction_id.nunique()
...
def get_image(name):
    ...
    safe_name = re.sub(' ', '_', name_split.lower())
    for filename in glob.glob("downloads/{name}/*jpg".format(name=safe_name)) + \
        ...
        return filename
    normal_name = re.sub(' ', '_', name_split)
    for filename in glob.glob("downloads/{name}/*jpg".format(name=normal_name)) + \
                    glob.glob("downloads/{name}/*png".format(name=normal_name)) + \
                    glob.glob("downloads/{name}/*jpeg".format(name=normal_name)):
        return filename
                        ...
                        [HBox(children=
                               [VBox(children=
                                     [widgets.HTML(value = f"<b><font color='orange'>{time[0]}</b>"),
                                      ...
                                      widgets.Image(value=loaded_images[0], format='jpg', width=300, height=400), 
                                ...
                                VBox(children=
                                     [widgets.HTML(value = f"<b><font color='orange'>{time[1]}</b>"), 
                                      widgets.HTML(value = f"<b><font color='purple'>{recommendations[0]}</b>"),
                                      widgets.Image(value=loaded_images[2], format='jpg', width=300, height=400), 
                         ...
                         HBox(children=
                               [VBox(children=
                                     [widgets.HTML(value = f"<b><font color='purple'>{recommendations[1]}</b>"),
                                      widgets.Image(value=loaded_images[1], format='jpg', width=300, height=400), 
                                ...
                                VBox(children=
                                     [widgets.HTML(value = f"<b><font color='purple'>{recommendations[1]}</b>"),
                                      widgets.Image(value=loaded_images[3], format='jpg', width=300, height=400), 
